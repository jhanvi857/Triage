...
var DeterministicTemplates = map[string]map[string]string{
	...
	diagnosis.CauseMandateRevoked: {
		...
		intervention.ActionSwitchToAvailableAlternateRail: "Hi {{customer_name}}, your recurring autopay needs to be re-authorized for {{amount}}. Refresh your UPI autopay mandate here: {{payment_link}}",
