...
var DeterministicTemplates = map[string]map[string]string{
	...
	diagnosis.CauseMandateLimit: {
		intervention.ActionSwitchToAvailableAlternateRail: "Hi {{customer_name}}, your transaction of {{amount}} exceeded your per-debit autopay cap. Your recurring mandate remains active. Complete this cycle instantly via One-Time UPI: {{payment_link}}",
		intervention.ActionRequestMandateLimitIncrease:    "Hi {{customer_name}}, to support higher billing limits for your subscription of {{amount}}, request a mandate limit update: {{payment_link}}",
